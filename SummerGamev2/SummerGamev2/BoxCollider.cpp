...
bool BoxCollider::willUpdate(sf::Vector2f center)
{
...
void BoxCollider::pushParent(GameObject* obj)
{
	m_aParents.push_back(obj);
}
GameObject* BoxCollider::getFromParents(int i)
{
	if (i < m_aParents.size())
	{
		return m_aParents[i];
	}
	else
